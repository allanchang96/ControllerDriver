...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, SwitchDriverQueueInitialize)
#endif

NTSTATUS
SwitchDriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = SwitchDriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = SwitchDriverEvtIoStop;
...
VOID
SwitchDriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
